    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="container px-5 mx-auto"> <!-- py-24 を削除 -->
                    <!-- 削除 -->
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="w-full rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $contact->id }}</div>
                        </div>
                        </div>
                        <div class="p-2 w-full">
                        <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            @if($contact->url) <!-- あったら表示、ないなら表示されない -->
                        ...
                        <div class="p-2 w-full">
                        <div class="relative">
                            <label class="leading-7 text-sm text-gray-600">性別</label><br> <!-- ラジオボタン -->
                        ...
                        <div class="p-2 w-full">
                        <div class="relative">
                            <label for="age" class="leading-7 text-sm text-gray-600">年齢</label> <!-- セレクトボックス -->
                        ...
                        <form method="get" action="{{ route('contacts.edit', ['id' =>$contact->id]) }}"> <!-- 編集画面へ飛ぶ -->
                        <div class="p-2 w-full">
